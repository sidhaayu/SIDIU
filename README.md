This repository contains HTML and CSS files demonstrating basic web development concepts such as semantic HTML tags and CSS styling. Below is a brief overview of the files and their contents:
